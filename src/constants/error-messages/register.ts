...
export const MINIMUM_CHAR_PASSWORD =
  'The password must minimum of 8 characters, including a mix of upper and lower case letters and at least one number.';
export const PASSWORD_NOT_MATCH = 'Passwords do not match.';
export const INVALID_EMAIL_FORMAT = 'Please enter a valid email.';
export const PLEASE_ENTER_VALID_PASSWORD = 'Please enter a valid password.';
