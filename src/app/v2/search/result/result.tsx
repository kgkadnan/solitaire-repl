  ...
  return (
    <div>
      ...
      <div className="border-[1px] border-neutral200 rounded-[8px] h-[calc(100vh-160px)] shadow-inputShadow">
        <div className="min-h-[72px] flex items-center justify-between border-b-[1px] border-neutral200 p-[16px]">
          <Breadcrum searchParameters={searchParameters} isActive={activeTab} />
          <ActionButton
            actionButtonData={[
              {
                variant: 'secondary',
              ...
              { variant: 'secondary', svg: BinIcon, handler: handleNewSearch }
            ]}
          />
        </div>
        <CalculatedField
