...
// //       // Scrolling down
// //       nextClick(sustainabilitySection.findIndex(section => section.id === carouselIndex));
// //     } else if (currentScrollY < lastScrollY) {
// //       // Scrolling up
// //       prevClick(sustainabilitySection.findIndex(section => section.id === carouselIndex));
// //     }
...
//       nextClick(sustainabilitySection.findIndex(section => section.id === carouselIndex));
//       setIsScrolling(true)
//     } else if (currentScrollY+700 < lastScrollY) {
//       // Scrolling up
//       prevClick(sustainabilitySection.findIndex(section => section.id === carouselIndex));
//     }
...
const App: React.FC = () => {
  ...
  const handleScroll = (e: Event) => {
    if (carouselIndex < '17') {
      e.preventDefault(); // Block global scrolling
    }
    ...
    // }
    if (currentScrollY - lastScrollY > 500 && carouselIndex < '17') {
      // Scrolling down
      nextClick(
        sustainabilitySection.findIndex(section => section.id === carouselIndex)
      );
      setLastScrollY(currentScrollY);
    } else if (lastScrollY - currentScrollY > 500 && carouselIndex > '0') {
      // Scrolling up
      prevClick(
        sustainabilitySection.findIndex(section => section.id === carouselIndex)
      );
