  ...
  return (
    <div className="font-sans mx-8 my-5 leading-7">
      ...
      <p className="text-base text-gray-600">
        ...
        component allows users to view and manage their account information,
        including personal details, KYC status, and preferences. It supports
        functionalities such as uploading profile photos, changing passwords,
        managing notification preferences, and reviewing privacy policies and
        ...
        <tbody>
          <tr>
            ...
            <td className="p-3 border text-gray-700">
              The user's account information, including personal details (first
              name, last name, email, phone), KYC status, and account metadata.
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className="p-3 border text-gray-700">string</td>
            <td className="p-3 border text-gray-700">
              The URL of the user's profile photo. If not provided, a default
              image is shown. This is useful for scenarios where users may
      ...
      <p className="text-base text-gray-600">
        The <code className="bg-gray-200 p-1 rounded">My Account</code>{' '}
        component contains the following tabs:
      </p>
      <ul className="list-disc ml-5 mt-2">
        <li>
          <strong>Table Preferences:</strong> Manage table preferences and
          settings.
        </li>
        <li>
          <strong>Change Password:</strong> Update the account password.
        </li>
        <li>
          <strong>Notifications Preferences:</strong> Configure notification
          settings.
        </li>
        <li>
          <strong>Privacy Policy:</strong> View and manage privacy policy
          settings.
        </li>
        <li>
          <strong>Terms and Conditions:</strong> Review terms and conditions.
        </li>
        <li>
          <strong>Profile Update:</strong> Update profile details and upload a
          new profile photo.
        </li>
      </ul>
    </div>
