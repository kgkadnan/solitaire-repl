...
import { ITermsDialog, TermsDialogComponent } from '@/app/v2/kyc/components/terms-and-conditions';
    ...
    return (
      <div className="font-sans mx-8 my-5 leading-7">
        ...
        <p className="text-base text-gray-600">
          This documentation provides details on the various components used in the KYC module. Each component serves a specific function in the KYC process and includes props and usage examples.
        </p>
        <section>
                <h2 className="text-xl text-gray-800 mt-5">CompanyOwnerDetail Component</h2>
                <p className="text-base text-gray-600 mt-3">
                    The <code className="bg-gray-200 p-1 rounded">CompanyOwnerDetail</code> component displays and manages details of the company owner, including form fields for personal and contact information. It integrates form error handling and state management.
                </p>
                <button
                ...
                <table className="w-full border-collapse mt-5">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="p-3 border text-gray-700">The error state of the form fields</td>
                        </tr>
                        <tr>
                            <td className="p-3 border text-gray-700">formState</td>
                            <td className="p-3 border text-gray-700">Object</td>
                            <td className="p-3 border text-gray-700">The current state of the form fields</td>
                        </tr>
                        <tr>
                            <td className="p-3 border text-gray-700">dispatch</td>
                            <td className="p-3 border text-gray-700">(action: any) => void</td>
                            <td className="p-3 border text-gray-700">Function to dispatch actions</td>
                        </tr>
                        <tr>
                            <td className="p-3 border text-gray-700">currentStepperStep</td>
                            <td className="p-3 border text-gray-700">number</td>
                            <td className="p-3 border text-gray-700">The current step in the stepper</td>
                        </tr>
                    </tbody>
                </table>
            </section>
        ...
        <p className="text-base text-gray-600 mt-3">
          The <code className="bg-gray-200 p-1 rounded">RenderAttachment</code> component handles the display and management of attachments. It includes functionalities for file upload and attachment management.
        </p>
        <button
          className="bg-blue-500 text-white border-none py-1 px-2 rounded cursor-pointer mt-5"
        ...
        <table className="w-full border-collapse mt-5">
          ...
          <tbody>
            <tr>
              <td className="p-3 border text-gray-700">formErrorState</td>
              <td className="p-3 border text-gray-700">FormErrorState</td>
              <td className="p-3 border text-gray-700">State object containing form error details</td>
            </tr>
            <tr>
              <td className="p-3 border text-gray-700">formState</td>
              <td className="p-3 border text-gray-700">FormState</td>
              <td className="p-3 border text-gray-700">Current state of the form</td>
            </tr>
            <tr>
              <td className="p-3 border text-gray-700">modalSetState</td>
              <td className="p-3 border text-gray-700">() => void</td>
              <td className="p-3 border text-gray-700">Function to set modal state</td>
            </tr>
            <tr>
              <td className="p-3 border text-gray-700">modalState</td>
              <td className="p-3 border text-gray-700">boolean</td>
              <td className="p-3 border text-gray-700">Boolean indicating if the modal is open</td>
            </tr>
            <tr>
              <td className="p-3 border text-gray-700">country</td>
              <td className="p-3 border text-gray-700">string</td>
              <td className="p-3 border text-gray-700">Country code for the form</td>
            </tr>
            <tr>
              <td className="p-3 border text-gray-700">handleTermAndCondition</td>
              <td className="p-3 border text-gray-700">() => void</td>
              <td className="p-3 border text-gray-700">Function to handle term and condition changes</td>
            </tr>
            <tr>
              <td className="p-3 border text-gray-700">selectedSubmissionOption</td>
              <td className="p-3 border text-gray-700">string</td>
              <td className="p-3 border text-gray-700">Selected submission option</td>
            </tr>
            <tr>
              <td className="p-3 border text-gray-700">currentStepperStep</td>
              <td className="p-3 border text-gray-700">number</td>
              <td className="p-3 border text-gray-700">Current step in the form wizard</td>
            </tr>
            <tr>
              <td className="p-3 border text-gray-700">AttachmentData</td>
              <td className="p-3 border text-gray-700">AttachmentData</td>
              <td className="p-3 border text-gray-700">Attachment data details</td>
            </tr>
          </tbody>
        </table>
        ...
        <p className="text-base text-gray-600 mt-3">
          The <code className="bg-gray-200 p-1 rounded">BankingDetails</code> component displays and manages banking information. It includes fields for bank details and error handling.
        </p>
        <button
          className="bg-blue-500 text-white border-none py-1 px-2 rounded cursor-pointer mt-5"
        ...
        <p className="text-base text-gray-600 mt-3">
          The <code className="bg-gray-200 p-1 rounded">CountrySelection</code> component allows users to select a country. It includes a state for the selected country and a handler for country changes.
        </p>
        <button
          className="bg-blue-500 text-white border-none py-1 px-2 rounded cursor-pointer mt-5"
        ...
        <table className="w-full border-collapse mt-5">
          ...
          <tbody>
            <tr>
              ...
              <td className="p-3 border text-gray-700">string</td>
              <td className="p-3 border text-gray-700">Currently selected country</td>
            </tr>
            <tr>
              <td className="p-3 border text-gray-700">handleCountrySelection</td>
              <td className="p-3 border text-gray-700">function</td>
              <td className="p-3 border text-gray-700">Function to handle country selection</td>
            </tr>
          </tbody>
        </table>
        ...
        <p className="text-base text-gray-600 mt-3">
          The <code className="bg-gray-200 p-1 rounded">PersonalDetail</code> component captures and displays personal details such as name, phone number, and email.
        </p>
        <button
          className="bg-blue-500 text-white border-none py-1 px-2 rounded cursor-pointer mt-5"
        ...
        <p className="text-base text-gray-600 mt-3">
          The <code className="bg-gray-200 p-1 rounded">RenderOffline</code> component displays content when the user is offline and handles offline-related errors.
        </p>
        <button
          className="bg-blue-500 text-white border-none py-1 px-2 rounded cursor-pointer mt-5"
        ...
        <table className="w-full border-collapse mt-5">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="p-3 border text-gray-700">string</td>
              <td className="p-3 border text-gray-700">Country code indicating where the form was submitted from</td>
            </tr>
          </tbody>
        </table>
        ...
        <p className="text-base text-gray-600 mt-3">
          The <code className="bg-gray-200 p-1 rounded">SubmissionOption</code> component lets users select a submission option and handles navigation.
        </p>
        <button
          className="bg-blue-500 text-white border-none py-1 px-2 rounded cursor-pointer mt-5"
        ...
        <table className="w-full border-collapse mt-5">
          ...
          <tbody>
            <tr>
              <td className="p-3 border text-gray-700">selectedSubmissionOption</td>
              <td className="p-3 border text-gray-700">string</td>
              <td className="p-3 border text-gray-700">Currently selected submission option</td>
            </tr>
            <tr>
              <td className="p-3 border text-gray-700">handleSubmissionOptionClick</td>
              <td className="p-3 border text-gray-700">function</td>
              <td className="p-3 border text-gray-700">Function to handle submission option click</td>
            </tr>
            <tr>
              <td className="p-3 border text-gray-700">handleBack</td>
              <td className="p-3 border text-gray-700">function</td>
              <td className="p-3 border text-gray-700">Function to handle navigation back</td>
            </tr>
          </tbody>
        </table>
        ...
        <p className="text-base text-gray-600 mt-3">
          The <code className="bg-gray-200 p-1 rounded">TermsDialogComponent</code> displays a dialog for terms and conditions with customizable styles.
        </p>
        <button
          className="bg-blue-500 text-white border-none py-1 px-2 rounded cursor-pointer mt-5"
        ...
        <table className="w-full border-collapse mt-5">
          ...
          <tbody>
            <tr>
              ...
              <td className="p-3 border text-gray-700">boolean</td>
              <td className="p-3 border text-gray-700">Boolean indicating if the dialog is open</td>
            </tr>
            <tr>
              <td className="p-3 border text-gray-700">dialogStyle</td>
              <td className="p-3 border text-gray-700">object</td>
              <td className="p-3 border text-gray-700">Custom styles for the dialog</td>
            </tr>
          </tbody>
        </table>
      </div>
...
const RenderAttachmentTemplate: Story<any> = (args) => <RenderAttachment {...args} />;
...
RenderAttachmentStory.args = {
  ...
  modalState: false,
  country: 'USA',
  handleTermAndCondition: (val: boolean) => AttachmentData({ name: 'formState.termAndCondition', value: val }),
  selectedSubmissionOption: 'online',
  currentStepperStep: 1,
  AttachmentData: AttachmentData,
};
...
const SubmissionOptionTemplate: Story<any> = (args) => <SubmissionOption {...args} />;

export const SubmissionOptionStory = SubmissionOptionTemplate.bind({});
SubmissionOptionStory.args = {
  selectedSubmissionOption: 'online',
  handleSubmissionOptionClick: (option: string) => console.log('Selected Option:', option),
