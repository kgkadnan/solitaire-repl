    ...
    return (
      <div className="font-sans mx-8 my-5 leading-7">
        ...
        <p className="text-base text-gray-600">
          The <code className="bg-gray-200 p-1 rounded">OrderDetail</code> Component is used to display detailed information about a specific order. It includes various features like displaying product details, handling image modals, downloading data as Excel files, and navigating between different views.
        </p>
