  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: 'space-x-1 flex items-center disabled:text-neutral400',
        nav_button: cn('h-7 w-7 bg-transparent p-0 disabled:text-neutral400'),
        nav_button_previous:
          'absolute left-1 border-none outline-none text-neutral900',
        nav_button_next:
          'absolute right-1 border-none outline-none text-neutral900 disabled:text-neutral400',
