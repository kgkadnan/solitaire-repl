...
const SavedSearchDropDown = ({
  ...
  return (
    <>
      {isOpen && (
        <div className="flex flex-col border-[1px] border-solid border-neutral200 bg-neutral0 h-auto min-h-[410px] w-[345px] rounded-[8px] p-[24px] gap-[16px] absolute top-[45px] right-[186px] z-[3]">
