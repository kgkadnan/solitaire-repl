...
//         const videoCurrentTime = Math.min(frameNumber, videoRef.current.duration); // Ensure currentTime does not exceed video duration
...
//   return (
//     <div ref={containerRef} style={{ height: videoHeight, overflow: 'hidden', position: 'relative', zIndex: 1, }}>
//       <video
//         ref={videoRef}
//         id="v0"
//         preload="auto"
//         muted
//         style={{ position: 'fixed', top: 50, left: 0, width: '100%', zIndex: 2 }}
//       >
//         <source
//           type="video/mp4"
...
const VideoScrollComponent: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <source type="video/mp4" src="/v3/icons/globe.mp4" />
      </video>
