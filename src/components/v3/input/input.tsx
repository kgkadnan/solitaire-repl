...
import { IInputFieldProps } from '@/interface/v3/input';
    ...
    <div className={`text-left w-full gap-1  ${styles?.inputMain}`}>
      ...
      <div className="flex relative items-center">
        <Input
          ...
          className={`h-[40px] focus:outline-none focus:border-[3px] focus:border-[#CFD1D4] focus-visible:border-[#CFD1D4] hover:border-neutral900 bg-neutral25 text-neutral900 border-[1px] w-full p-2 rounded-[4px] disabled:bg-neutral100 disabled:text-neutral-500  ${
            disabled &&
            'cursor-not-allowed bg-neutral100 text-neutral-500 hover:border-neutral-200'
          } ${
            errorText
